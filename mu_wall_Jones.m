function [mu,Z] = mu_wall_Jones(a,h,mu_tt,mu_rr,mu_rt,A,B,C)
    t = a/h;
    ...
    Z  = [[psi_tt/mu_tt 0 0 0 psi_tr/mu_rt 0] ; [0 psi_tt/mu_tt 0 -psi_tr/mu_rt 0 0] ; [0 0 phi_tt/mu_tt 0 0 0] ; [0 -psi_tr/mu_rt 0 psi_rr/mu_rr 0 0] ; [psi_tr/mu_rt 0 0 0 psi_rr/mu_rr 0] ; [0 0 0 0 0 phi_rr/mu_rr]];
